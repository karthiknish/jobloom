// Script to populate Firebase with interview questions
...
async function populateQuestions() {
  try {
    console.log('Starting to populate interview questions...');
    ...
    await batch.commit();
    console.log(`Successfully saved ${questionCount} interview questions to Firebase!`);

    // Verify the data was saved
    const snapshot = await db.collection("interviewQuestions").limit(5).get();
    console.log(`Verification: Found ${snapshot.size} questions in database`);
