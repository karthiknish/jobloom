...
export function DashboardAnalytics({
  ...
  return (
    ...
    >
      ...
      {/* CV Analysis Section - Accessible to all */}
      <Card>
        <CardHeader>
      ...
      {/* Application Timeline - Accessible to all */}
          ...
          <CardContent>
            <div className="space-y-4">
              {safeApplications
                ...
                .slice(0, 5) // Shorter preview for free users
            ...
            {safeApplications.length > 5 && (
              <div className="text-center mt-4 pt-4 border-t border-dashed">
                <p className="text-xs text-muted-foreground">
                  Upgrade to view all {safeApplications.length} applications
                </p>
              </div>
            )}
          </CardContent>
      ...
      {/* Advanced Insights Gated Content */}
      <FeatureGate 
        feature="advancedAnalytics" 
        fallback={<AnalyticsTeaser />}
      >
        <div className="space-y-6 pt-6 border-t border-border/50">
          <div className="flex items-center gap-2 mb-2">
            <BarChart3 className="h-5 w-5 text-primary" />
            <h3 className="text-lg font-bold">Advanced Insights</h3>
          </div>
  ...
  return (
    <div className="relative mt-8">
      <div className="absolute inset-0 bg-background/60 backdrop-blur-[4px] z-10 flex flex-col items-center justify-center p-6 text-center rounded-2xl border border-dashed border-primary/30">
        ...
        <h3 className="text-xl font-bold mb-2">Unlock Deeper Insights</h3>
        <p className="text-muted-foreground mb-6 max-w-sm">
          Want to see your application funnel, success metrics, and salary analytics? Upgrade to Premium to see your full progress.
        </p>
        <Link href="/upgrade">
          <Button className="bg-primary hover:bg-primary/90 rounded-xl px-8 shadow-md">
            Go Premium
          </Button>
        </Link>
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 opacity-40 select-none pointer-events-none grayscale-[0.5]">
        <Card>
          <CardHeader><CardTitle>Application Trends</CardTitle></CardHeader>
          <CardContent><div className="h-24 bg-muted animate-pulse rounded-lg" /></CardContent>
        </Card>
        <Card>
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent><div className="h-32 bg-muted animate-pulse rounded-lg" /></CardContent>
        </Card>
      </div>
    </div>
  );
