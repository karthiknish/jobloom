...
export function DashboardEmptyState({
  ...
  return (
    ...
    >
      ...
      >
        <div className="rounded-2xl bg-gradient-to-br from-white via-emerald-50/50 to-teal-50/50 dark:from-background dark:via-emerald-950/20 dark:to-teal-950/20 p-8 md:p-12 text-center shadow-xl border border-primary/20 dark:border-emerald-900/50 relative overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            ...
            >
              <Badge className="mt-6 mb-4 bg-primary/20 dark:bg-emerald-900/50 text-primary dark:text-emerald-300 border-primary/30 dark:border-emerald-800 hover:bg-primary/20">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              >
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto shadow-md hover:shadow-lg transition-all duration-300 border-border hover:border-emerald-300 hover:bg-primary/10/50 dark:hover:bg-emerald-950/30 gap-2"
                >
                  Track Application
      ...
      >
        {/* Feature 1 - Extension */}
        <div className="p-5 rounded-xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-primary/20 dark:border-emerald-900/50 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 rounded-lg bg-primary/20 dark:bg-emerald-900/50">
              <Chrome className="h-5 w-5 text-primary dark:text-emerald-400" />
            </div>
            <h4 className="font-semibold text-primary dark:text-emerald-100">Browser Extension</h4>
          </div>
