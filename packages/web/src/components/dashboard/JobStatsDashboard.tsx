              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">{stats.totalJobs}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-3xl font-bold bg-gradient-to-r from-orange-600 to-orange-800 bg-clip-text text-transparent">{stats.sponsoredJobs}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-3xl font-bold bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">{stats.totalApplications}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">{stats.jobsToday}</p>
                  </div>
                </div>
                  ...
                  <div key={status} className="group/status">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        <Badge 
                          variant={statusVariants[status as keyof typeof statusVariants] || "secondary"}
                    ...
                    <div className="relative">
                      ...
                      <div 
                        ...
                        style={{ 
                          width: `${getPercentage(count, stats.totalApplications)}%`,
              ...
              <div className="space-y-4">
                    ...
                    <TooltipTrigger asChild>
                      <div className="group/insight flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100   rounded-xl hover:from-gray-100 hover:to-gray-200   transition-all duration-300 cursor-help">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <span className="font-semibold text-foreground">Agency Jobs</span>
                            <p className="text-xs text-muted-foreground">Recruitment agency postings</p>
                          </div>
                        </div>
                      ...
                      <div className="group/insight flex items-center justify-between p-4 bg-gradient-to-r from-orange-50 to-orange-100   rounded-xl hover:from-orange-100 hover:to-orange-200   transition-all duration-300 cursor-help">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <p className="text-xs text-muted-foreground">Company-sponsored positions</p>
                          </div>
                        </div>
                ...
                <div className="group/insight flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-green-100   rounded-xl hover:from-green-100 hover:to-green-200   transition-all duration-300">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <span className="font-semibold text-foreground">Application Rate</span>
                      <p className="text-xs text-muted-foreground">Jobs applied to vs total</p>
                    </div>
                  </div>
