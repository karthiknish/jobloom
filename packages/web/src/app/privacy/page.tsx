    ...
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-gray-800">
      ...
      <section className="space-y-6">
        <p>
          ...
          Jobloom (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) collects,
          uses, and protects your personal information when you use our website,
          Chrome extension, and related services (collectively, the
          &quot;Service&quot;).
        </p>
        ...
        <p>
          ...
          collect certain information when you use the Service, such as log data
          and device information. Our Chrome extension may collect the URLs of
          job listings you visit to identify sponsored postings.
        </p>

        <h2 className="text-xl font-semibold">2. How We Use Information</h2>
        <p>
          We use your information to deliver and improve the Service, provide
          customer support, and communicate updates. We never sell your data.
        </p>

        <h2 className="text-xl font-semibold">3. Data Security</h2>
        <p>
          We employ industry-standard security measures—encryption in transit
          and at rest—to protect your data from unauthorized access.
        </p>
        ...
        <p>
          ...
          <Link href="mailto:privacy@jobloom.ai" className="text-indigo-600">
            {" "}
            privacy@jobloom.ai
          </Link>
          .
