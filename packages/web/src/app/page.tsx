        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold text-foreground">Install Extension</h3>
            ...
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-gradient-to-br from-primary/90 to-primary/60 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
                <span className="text-2xl font-bold text-white">2</span>
              </div>
              <h3 className="text-xl font-semibold text-foreground">Spot Sponsored Jobs</h3>
              <p className="text-secondary-foreground leading-relaxed">
            ...
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-gradient-to-br from-primary/80 to-primary/50 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
                <span className="text-2xl font-bold text-white">3</span>
              </div>
              <h3 className="text-xl font-semibold text-foreground">Track Applications</h3>
              <p className="text-secondary-foreground leading-relaxed">
      ...
      <section id="features" className="py-24 bg-gradient-to-br from-muted/20 via-background to-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-card/90 rounded-2xl p-8 border border-primary/10 shadow-sm hover:shadow-md transition-all text-center">
              <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                <Target className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-4">Smart Detection</h3>
              <p className="text-secondary-foreground leading-relaxed">
            ...
            <div className="bg-card/90 rounded-2xl p-8 border border-primary/10 shadow-sm hover:shadow-md transition-all text-center">
              <div className="w-16 h-16 bg-secondary/60 rounded-2xl flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="bg-card/90 rounded-2xl p-8 border border-primary/10 shadow-sm hover:shadow-md transition-all text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Real-time Sync</h3>
              <p className="text-secondary-foreground leading-relaxed">
            ...
            <div className="bg-card/90 rounded-2xl p-8 border border-primary/10 shadow-sm hover:shadow-md transition-all text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-4">Company Intelligence</h3>
              <p className="text-secondary-foreground leading-relaxed">
